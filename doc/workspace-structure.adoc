...
** `:parameters` Set for functions and macros.
Specifies the function/macro parameters:
...
Can either be explicitly passed in together with the `poly` command, or implicitly set by the xref:commands.adoc#switch-ws, using the `file` parameter.
