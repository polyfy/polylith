...
We can list what's included in a release with e.g.:

[source,shell]
----
poly ws get:releases:0.2.18-SNAPSHOT:
----

[source,shell]
----
issue-187   issue-277   issue-294   pr-275
issue-205   issue-282   issue-304   pr-319
issue-259   issue-286   issue-309   pr-323
issue-264   issue-289   issue-312   pr-324
issue-272   issue-290   issue-318   ws-2.0
issue-274   issue-293   pr-268
----
...
[source,shell]
----
# List the content of all releases:
poly ws get:releases

# List the content of a specific release:
poly ws get:releases:0.2.18-SNAPSHOT
----

Each release consists of issues, e.g.:

[source,shell]
----
poly ws get:releases:0.2.18-SNAPSHOT:issue-187
----
...
And sometimes PRs, e.g.:

[source,shell]
----
poly ws get:releases:0.2.18-SNAPSHOT:pr-319
----
...
If the xref:workspace-structure.adoc[workspace structure] has changed,
we can list the changed attributes, by giving the new workspace structure version, e.g.:

[source,shell]
----
ws get:releases:0.2.18-SNAPSHOT:ws-2.0
----

[source,clojure]
----
{:attributes [{:attribute "ws-type", :description "Added"}
              {:attribute "projects:PROJECT:deps:BRICK:SOURCE:missing-ifc-and-bases",
               :description "Renamed from missing-ifc."}
              {:attribute "ENTITIES:ENTITY:namespaces:SOURCE:0:file-path",
               :description "The ws-dir part was removed from the file path."}
              {:attribute "ENTITIES:ENTITY:namespaces:SOURCE:0:is-invalid",
               :description "Added"}
              {:attribute "ENTITIES:ENTITY:namespaces:SOURCE:0:is-ignored",
               :description "Added"}
              {:attribute "version:tool", :description "Added"}
              {:attribute "version:release:snapshot", :description "Added"}
              {:attribute "version:test-runner-api", :description "Added"}
              {:attribute "bases:BASE:base-deps", :description "Added"}
              {:attribute "configs", :description "Added"}
              {:attribute "releases", :description "Added"}],
:name "ws-2.0"}
----

Information on how the workspace structure is version controlled, can be found xref:workspace-structure.adoc#version[here].
