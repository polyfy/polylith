...
* `:keep-lib-versions` A vector containing the library names that should not be affected when executing `poly libs :update`.
...
See xref:libraries.adoc#update[update libs].
