...
For Windows systems the _color-mode_ is set to "none" and for all other systems,
"dark" will be used as default. Valid values are: "none", "light" and "dark".

In this documentation we have used the _dark_ color schema,
but we can switch to _light_ by giving the _color-mode_ parameter
...
The only difference between _light_ and _dark_ is that they use different
