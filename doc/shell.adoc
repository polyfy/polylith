...
If we press `<tab>`, it will complete the xref:commands.adoc#info[info] command and suggest available parameters:
...
If we are outside a workspace, we will get some guidance:
