...
The manual steps for creating a release are detailed in the  xref:developing-poly.adoc#make-a-snapshot-release[snapshot] and xref:developing-poly.adoc#make-a-stable-release[stable] sections on the Developing Poly page.
