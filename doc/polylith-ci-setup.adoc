...
A release is triggered when a release https://github.com/polyfy/polylith/tags[tag], e.g. `v0.2.18`, is added to a commit in the https://github.com/polyfy/polylith[polyfy/polylith] repository in GitHub:
