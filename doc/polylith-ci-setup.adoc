...
====
NOTE: The https://github.com/polyfy/polylith/blob/master/next-release.txt[next-release.txt] file lists what has been included in the SNAPSHOT release, since the previous final release.
