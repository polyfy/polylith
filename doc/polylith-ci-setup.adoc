...
* A https://github.com/polyfy/polylith/releases[release] of the `poly` tool is triggered by tagging a commit in the
...
* This will also release a snapshot version of the https://clojars.org/polylith/clj-poly[clj-poly] library to Clojars.
* Which triggers a build of the snapshot version of the https://cljdoc.org/d/polylith/clj-poly/CURRENT/doc/readme[clj-doc] documentation.
