...
* A https://github.com/polyfy/polylith/releases[release] of the `poly` tool (`v0.2.18` and `v0.2.19` in this example) is triggered by tagging a commit in the
https://github.com/polyfy/polylith[polyfy/polylith] repository in GitHub.
* This will also release the https://clojars.org/polylith/clj-poly[polylith/clj-poly] library to Clojars.
* Which triggers a build of the web based https://cljdoc.org/d/polylith/clj-poly/CURRENT/doc/readme[polylith/clj-doc] documentation.

==== Snapshot release

* A commit is tagged/retagged with a SNAPSHOT version in the https://github.com/polyfy/polylith[polyfy/polylith] repository in GitHub.
* This will trigger a snapshot release of the https://clojars.org/polylith/clj-poly[polylith/clj-poly] library to Clojars (`0.2.19-SNAPSHOT` in the example).
* Which triggers a build of the snapshot version of the https://cljdoc.org/d/polylith/clj-poly/CURRENT/doc/readme[polylith/clj-doc] documentation (`0.2.19-SNAPSHOT`).
