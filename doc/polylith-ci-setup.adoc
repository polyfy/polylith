...
There are two types of releases, final and shapshot.
...
* This will also release the {cljdoc-api-url}/polylith[clj-poly] library to Clojars.
...
* This will trigger a snapshot release of the {cljdoc-api-url}/polylith[clj-poly] library to Clojars (`0.2.19-SNAPSHOT` in the example).
