...
In that case it makes sense to put the implementation directly in the interface namespace.
...
This check is performed when running the _check_, _info_ or _test_ command.
