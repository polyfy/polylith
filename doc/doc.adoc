...
* The image:images/cljdoc-snapshot-badge.png[] badge takes us to the latest `SNAPSHOT` build of this documentation,
which is the one we should use if we work on code in the
https://github.com/polyfy/polylith[master] branch and if something new has been pushed to that
