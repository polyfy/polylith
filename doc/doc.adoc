...
The easiest way to access different parts of the documentation is by first starting a shell:
...
Now we can execute the `doc` command to open the start page of this documentation:
