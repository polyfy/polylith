...
* image:images/gitbook-badge.png[] opens the documentation for the latest https://github.com/polyfy/polylith/releases[release]
which the documentation you should use if you use

* image:images/cljdoc-snapshot-badge.png[] opens the latest `SNAPSHOT` version of this documentation.
