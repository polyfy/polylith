...
The old https://github.com/tengstrand/lein-polylith[lein-polylith] tool has reached the end of its life and has been replaced by this tools.deps based version.
...
If the workspace has been created with https://github.com/polyfy/polylith/releases/tag/v0.1.0-alpha9[v0.1.0-alpha9] or earlier, then it has to be migrated by following the instructions xref:migrate-workspace-from-v1-to-v2.adoc[here].
