...
| 5.1 | 0.3.30 | added | libraries | A list of all libraries used within the workspace.
| 5.0 | 0.3.0 | added | ws-dialects | A set of supported dialects. Valid values: "clj" and/or "cljs".
|  |  | added | configs:ENTITIES:ENTITY:package | Configuration retrieved from the package.json file.
|  |  | added | ENTITIES:ENTITY:source-types | A set of source types (file suffixes) covering all used source files ("clj", "cljc", "cljs").
