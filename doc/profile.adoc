...
TIP: You likely don't need profiles if your xref:workspace.adoc[workspace] does not include xref:interface.adoc#one-interface-in-multiple-components[duplicate interfaces].
