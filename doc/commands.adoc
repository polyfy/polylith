...
[source,text]
----
  poly 0.3.33 (2026-08-09) - https://github.com/polyfy/polylith
...
----
  ...
  Most warnings and errors can be suppressed via the :validations > :disable
  key in ./workspace.edn. For more information, execute: 'poly doc page:validations'.
