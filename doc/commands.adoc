...
[source,text]
----
  poly 0.3.22 (2024-12-29) - https://github.com/polyfy/polylith
...
Polylith uses templates for each of the files it creates via this command.
Those can be overridden on a global (per-user) or per-project basis.
See the xref:templates.adoc[templates documentation] for more details.
