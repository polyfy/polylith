...
If you know what you're doing, you can suppress warnings and errors.
...
If you want to turn off validation for all bricks, update `workspace.edn` as follows:
...
A validation for a specific project can be suppressed:
...
More than one validation can be suppressed:
...
Another way to suppress warning 207 is to add the key `:neccessary` to the project configuration.
