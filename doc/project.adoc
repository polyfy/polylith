...
- It's normally discouraged to have a _src_ directory, e.g. _projects/my-project/src_, since all production code should normally only live in components and bases.
