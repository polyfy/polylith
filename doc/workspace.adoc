...
* The xref:development.adoc[development] project (`development/` + `deps.edn`) supports working on all code from one place. The `config.edn` file specifies the project alias ("dev").
