...
15. If the next release is a snapshot release, execute `git switch -c snapshot-022035`, otherwise follow the instructions for creating a stable release.
...
10. Execute `bb gen-all`
    ...
    - Commit and push the changes if everything looks correct (this will trigger a release).
