...
ifdef::env-cljdoc[]
link:../api/polylith.clj.core.test-runner-contract.interface#TestRunner[here].
endif::[]
ifndef::env-cljdoc[]
...
ifdef::env-cljdoc[]
link:../api/polylith.clj.core.test-runner-contract.interface#ExternalTestRunner[here].
endif::[]
ifndef::env-cljdoc[]
