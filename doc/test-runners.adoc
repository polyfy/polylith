include::cljdoc-attributes.adoc[]
= Test Runners
:toc:
...
link:{cljdoc-url}/api/polylith.clj.core.test-runner-contract.interface#TestRunner[here].

== ExternalTestRunnerProtocol

You can find the _ExternalTestRunner_ protocol
link:{cljdoc-url}/api/polylith.clj.core.test-runner-contract.interface#ExternalTestRunner[here].
