(ns ^:no-doc polylith.clj.core.nav-generator.main
  (:require [clojure.string :as str]
            [polylith.clj.core.nav-generator.command-generator :as command-gen]
...
(def filename "components/doc/src/polylith/clj/core/doc/navigation.clj")
...
(defn -main [& args]
  (spit filename (str "(ns ^:no-doc polylith.clj.core.doc.navigation)\n\n"
                      ";; This file is generated by the nav-generator component."))
  (save-file "command-nav" (command-gen/navigation))
