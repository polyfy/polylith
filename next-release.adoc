...
It unfortunately broke the Test Runner contract, but will make it easier to implement test runners in the future, because of the simplified structure (project related test config now lives in each project).
