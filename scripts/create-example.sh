...
echo "### 15/56 Realworld example app ###"
cd $ws2
echo "current-dir=$(pwd)"
...
echo "current-dir=$(pwd)"
echo "### 16/56 Realworld example app ###"
...
echo "### 23/56 Polylith toolsdeps1 ###"
cd $ws1
echo "current-dir=$(pwd)"
git clone git@github.com:polyfy/polylith.git
cd polylith
echo "### 24/56 Polylith toolsdeps1 ###"
...
echo "### 42/56 examples/local-dep-old-format ###"
...
echo "### 43/56 examples/local-dep-old-format ###"
...
echo "### 47/56 examples/local-dep-old-format (migrated) ###"
poly libs color-mode:none > $output/local-dep-old-format/libs-migrated.txt
echo "### 48/56 examples/local-dep-old-format (migrated) ###"
...
echo "current-dir=$(pwd)"
echo "### 50/56 examples/for-test ###"

echo "### 51/56 issue 208 - Mix clj and cljc source directories ###"
poly test :all project:okay color-mode:none > $output/for-test/okay.txt
echo "### 52/56 issue 234 - Test setup fails ###"
poly test :all project:okay:setup-fails:x-okay color-mode:none > $output/for-test/setup-fails-stops-entire-test-run.txt
echo "### 53/56 issue 234 - Test teardown fails ###"
...
echo "### 54/56 issue 234 - Test failed ###"
...
echo "### 55/56 issue 234 - Test failed, teardown failed ###"
