...
echo "### 6/57 Out ###"
echo "current-dir=$(pwd)"
poly info fake-sha:c91fdad out:$output/out-info-colored.txt
poly info fake-sha:c91fdad color-mode:none out:$output/out-info.txt
