...
(deftest info
  (is (= ["  interface            brick                   api  poly   dev"
          ...
          "  default-test-runner  default-test-runner *   ---  stx    st-"
          "  deps                 deps *                  s--  stx    st-"
          "  file                 file *                  s--  stx    st-"
          "  git                  git *                   s--  stx    st-"
          "  help                 help *                  ---  s--    s--"
          ...
          "  test-runner-plugin   test-runner-plugin *    s--  s--    s--"
...
(deftest ifc-deps-table
  (is (= ["                                      d                                                                     "
          ...
          "                                      t                    p           t  t  n     u                 r  w   "
          "                                      e                    a           e  e  n  t  s  u              k  s   "
          "                                      s                    t           s  s  e  e  e  s     v     w  s  -   "
          "                                      t                 m  h           t  t  r  x  r  e     a     o  p  e   "
          "                             c     c  -                 i  -           -  -  -  t  -  r     l  v  r  a  x  w"
          "                          c  o  c  r  r                 g  f           h  r  p  -  c  -     i  e  k  c  p  s"
          "                          h  m  o  e  u                 r  i     s     e  u  l  t  o  i     d  r  s  e  l  -"
          "                          a  m  m  a  n  d  f     h     a  n     h     l  n  u  a  n  n  u  a  s  p  -  o  f"
          "                       a  n  a  m  t  n  e  i  g  e  l  t  d     e  t  p  n  g  b  f  p  t  t  i  a  c  r  i"
          "                       p  g  n  o  o  e  p  l  i  l  i  o  e  s  l  a  e  e  i  l  i  u  i  o  o  c  l  e  l"
          "  brick                i  e  d  n  r  r  s  e  t  p  b  r  r  h  l  p  r  r  n  e  g  t  l  r  n  e  j  r  e"
          "  ----------------------------------------------------------------------------------------------------------"
          "  api                  .  x  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  x  .  .  .  x  x  x  ."
          "  change               .  .  .  .  .  .  .  .  x  .  .  .  x  .  .  .  .  .  .  .  .  .  x  .  .  .  .  .  ."
...
(deftest project-deps-table
  (let [ws (workspace)
    ...
    (is (= ["                                   d                                                                     "
            ...
            "                       h  m  o  e  u                 r  i     s     e  u  l  t  o  i     d  r  s  e  l  -"
            "                       a  m  m  a  n  d  f     h     a  n     h     l  n  u  a  n  n  u  a  s  p  -  o  f"
            "                       n  a  m  t  n  e  i  g  e  l  t  d     e  t  p  n  g  b  f  p  t  t  i  a  c  r  i"
            "                       g  n  o  o  e  p  l  i  l  i  o  e  s  l  a  e  e  i  l  i  u  i  o  o  c  l  e  l"
            "  brick                e  d  n  r  r  s  e  t  p  b  r  r  h  l  p  r  r  n  e  g  t  l  r  n  e  j  r  e"
            "  -------------------------------------------------------------------------------------------------------"
            "  change               .  .  .  .  .  .  +  x  .  .  .  x  +  .  .  .  .  .  .  .  .  x  .  .  .  .  .  ."
            "  command              x  .  x  x  +  x  x  x  x  x  x  +  +  x  x  .  x  +  +  x  +  x  x  x  x  x  x  x"
            "  common               .  .  .  .  .  .  x  .  .  .  .  .  .  .  .  .  .  .  .  x  .  x  .  .  .  .  .  ."
  ...
  (is (= {"change"             {:src  {:direct   ["git"
          ...
          "creator"            {:src  {:direct   ["common"
                                ...
                                :test {:direct   ["common"
                                       ...
                                       :indirect ["change"
                                                  ...
                                                  "ws-explorer"
                                                  "ws-file"]}}
          "default-test-runner" {:src {:direct ["test-runner-plugin"
                                                "util"]}
                                 :test {:direct ["test-runner-plugin"
                                                 "util"]}}
          ...
          "test-runner"        {:src  {:direct   ["common"
                                       ...
                                       :indirect ["file"
                                                  ...
                                                  "user-config"]}
                                :test {}}
          "test-runner-plugin" {:src  {:direct ["util"]}
                                :test {}}
...
(deftest poly-project-src-paths
  (is (= ["bases/poly-cli/src"
          ...
          "components/default-test-runner/src"
          "components/deps/src"
          "components/file/src"
          "components/git/src"
          "components/help/src"
...
(deftest poly-project-test-paths
  (is (= ["bases/poly-cli/test"
          ...
          "components/default-test-runner/test"
