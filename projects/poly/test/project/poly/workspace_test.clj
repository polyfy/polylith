...
(deftest info
  (is (= ["  interface      brick             api  depl  poly   dev"
          "  ------------------------------   ---------------   ---"
          "  api            api *             s--  s--   ---    st-"
          "  change         change *          s--  s--   stx    st-"
          "  command        command *         ---  ---   stx    st-"
          "  common         common *          s--  s--   s--    s--"
          "  creator        creator *         ---  ---   stx    st-"
          "  deployer       deployer *        ---  s--   ---    s--"
          "  deps           deps *            s--  s--   stx    st-"
          "  file           file *            s--  s--   stx    st-"
          "  git            git *             s--  s--   stx    st-"
          "  help           help *            ---  ---   s--    s--"
          "  lib            lib *             s--  s--   stx    st-"
          "  migrator       migrator *        ---  ---   stx    st-"
          "  path-finder    path-finder *     s--  s--   stx    st-"
          "  sh             sh *              s--  s--   s--    s--"
          "  shell          shell *           ---  ---   stx    st-"
          "  tap            tap *             ---  ---   s--    s--"
          ...
          "  user-input     user-input *      s--  s--   stx    st-"
          "  util           util *            s--  s--   stx    st-"
          "  validator      validator *       s--  s--   stx    st-"
          "  version        version *         s--  s--   s--    s--"
          "  workspace      workspace *       s--  s--   stx    st-"
...
(deftest libs
  (is (= ["                                                                                                           w   "
          ...
          "                                                                                      y  e  i  t  e  t  t  c  r"
          "                                                                                      e  p  l  o  l  a  o  l  e"
          "  library                       version        type      KB   api  depl  poly   dev   r  s  e  r  l  p  r  j  r"
          "  ---------------------------------------------------------   ---------------   ---   -------------------------"
          "  djblue/portal                 0.15.1         maven    742    -    -     x      x    .  .  .  .  .  x  .  .  ."
          "  me.raynes/fs                  1.4.6          maven     10    x    x     x      x    .  .  x  .  .  .  .  .  ."
          "  metosin/malli                 0.6.2          maven     50    x    x     x      x    .  .  .  .  .  .  x  .  ."
...
(deftest ifc-deps-table
  (is (= ["                                                                                            w      "
          ...
          "                 a  n  a  m  t  y  e  i  g  e  l  t  d     e  t  p  n  b  f  p  t  t  i  a  c  r  i"
          "                 p  g  n  o  o  e  p  l  i  l  i  o  e  s  l  a  e  e  l  i  u  i  o  o  c  l  e  l"
          "  brick          i  e  d  n  r  r  s  e  t  p  b  r  r  h  l  p  r  r  e  g  t  l  r  n  e  j  r  e"
          "  -------------------------------------------------------------------------------------------------"
          "  api            .  x  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  x  .  .  .  x  x  x  ."
          "  change         .  .  .  .  .  .  .  .  x  .  .  .  x  .  .  .  .  .  .  .  .  x  .  .  .  .  .  ."
...
(deftest poly-project-lib-imports
  (is (= {:src {"slipset/deps-deploy" {:size    8059
                                       :type    "maven"
                                       :version "0.2.0"}}}
