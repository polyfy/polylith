...
(deftest polylith-project-table
  (is (= (project-table/table (workspace) false false)
         ["  project        alias  source   dev  plain   "
          "  ----------------------------   ----------   "
          "  api *          api     ---     ---   --     "
          "  poly *         poly    -t-     -t-   --     "
          "  polyx *        polyx   ---     ---   --     "
...
(deftest polylith-info
  (is (= (ws-table/table (workspace) false false)
         ["  interface                 brick                        api  poly  polyx   dev  plain"
          "  ----------------------------------------------------   ----------------   ----------"
          "  antq                      antq *                       s--  s--    s--    s--   --  "
          "  api                       api *                        s--  ---    ---    st-   --  "
          "  change                    change *                     s--  stx    s--    st-   --  "
          "  clojure-test-test-runner  clojure-test-test-runner *   ---  stx    s--    st-   --  "
          "  command                   command *                    ---  stx    s--    st-   --  "
          "  common                    common *                     s--  stx    s--    st-   --  "
          "  config-reader             config-reader *              s--  stx    s--    st-   --  "
          "  creator                   creator *                    ---  stx    s--    st-   --  "
          "  deps                      deps *                       s--  stx    s--    st-   --  "
          "  file                      file *                       s--  stx    s--    st-   --  "
          "  git                       git *                        s--  stx    s--    st-   --  "
          "  help                      help *                       ---  s--    s--    s--   --  "
          "  image-creator             image-creator *              s--  s--    ---    ---   s-  "
          ...
          "  test-runner-contract      test-runner-contract *       s--  stx    s--    st-   --  "
          "  test-runner-orchestrator  test-runner-orchestrator *   ---  stx    s--    st-   --  "
          "  text-table                text-table *                 s--  s--    s--    s--   --  "
          "  user-config               user-config *                s--  s--    s--    s--   --  "
          "  user-input                user-input *                 s--  stx    s--    st-   --  "
          "  util                      util *                       s--  stx    s--    st-   --  "
          "  validator                 validator *                  s--  stx    s--    st-   --  "
          "  version                   version *                    s--  s--    s--    s--   --  "
          "  workspace                 workspace *                  s--  stx    s--    st-   --  "
          "  workspace-clj             workspace-clj *              s--  stx    s--    st-   --  "
          "  ws-explorer               ws-explorer *                s--  stx    s--    st-   --  "
...
(deftest polylith-libs
  (is (= (keep-except "clojure2d"
         ...
         ["                                                                                                                i                  "
          ...
          "                                                                                                       n  e  i  r  t  e  t  t  c  r"
          "                                                                                                       t  p  l  -  o  l  a  o  l  e"
          "  library                           version    type      KB   api  poly  polyx   dev  plain  default   q  s  e  x  r  l  p  r  j  r"
          "  ---------------------------------------------------------   ----------------   -------------------   ----------------------------"
          "  borkdude/edamame                  1.3.22     maven     24    x    x      x      x     -       -      .  .  x  .  .  .  .  .  .  ."
...
(deftest polylith-libs-outdated
  (is (= (keep-except "clojure2d"
         ...
         ["                                                                                                                        i                  "
          ...
          "                                                                                                               n  e  i  r  t  e  t  t  c  r"
          "                                                                                                               t  p  l  -  o  l  a  o  l  e"
          "  library                           version    latest  type      KB   api  poly  polyx   dev  plain  default   q  s  e  x  r  l  p  r  j  r"
          "  -----------------------------------------------------------------   ----------------   -------------------   ----------------------------"
          "  borkdude/edamame                  1.3.22             maven     24    x    x      x      x     -       -      .  .  x  .  .  .  .  .  .  ."
          "  clj-commons/fs                    1.6.310            maven     12    x    x      x      x     -       -      .  .  x  .  .  .  .  .  .  ."
          "  com.github.liquidz/antq           2.5.1095           maven     50    x    x      x      x     -       -      x  .  .  .  .  .  .  .  .  ."
...
(deftest polylith-workspace-ifc-deps-table
  (is (= (ws-ifc-deps-table/table (workspace))
         ["                                                                                           t                              "
          ...
          "                            n  n  a  m  d  t  e  i  g  e  t  l  t  i  d     e  t  t  p  a  t  b  f  p  t  t  i  a  c  r  i"
