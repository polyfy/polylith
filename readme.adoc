...
Polylith can be implemented in any programming language.
...
To give you an idea of what this can look like, take a quick look at the projects, bricks, and libraries we use to build the Clojure _poly_ tool.
(The _poly_ tool is, of course, written with Polylith.)

image::doc/images/example-systems/polylith.png[link="doc/images/example-systems/polylith.png"]

These tables were generated with the poly tool.
At a high level:

* The first table shows the bricks that make up the poly tool
* The second, describes brick usage across interfaces
* And the third, dependencies usage across projects and bricks

You'll understand what all this means after reading through the documentation.
