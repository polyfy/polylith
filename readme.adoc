...
ifdef::env-cljdoc[]
before continuing with the xref:introduction.adoc[introduction] (1).
endif::[]
ifndef::env-cljdoc[]
before continuing with the http://localhost:8000/d/polylith/clj-poly/0.2.18-issue318-02/doc/introduction[introduction] (2).
endif::[]
