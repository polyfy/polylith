...
ifeval::[{snapshot-counter} > 0 && env-cljdoc]
https://cljdoc.org/d/polylith/clj-poly/{current-version}-SNAPSHOT[image:https://badgen.net/badge/doc/{current-version}-SNAPSHOT%20%23{snapshot-counter}/cyan[]]
endif::[]
