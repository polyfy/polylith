...
:snapshot-number: 2
:snapshot-version: 0.3.34
:stable-version: 0.3.33
...
image:https://avatars.githubusercontent.com/u/12722744[link=https://github.com/bpringe,alt="Brandon Ringe",width=32,role="left"]
