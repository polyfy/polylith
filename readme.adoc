...
ifndef::env-cljdoc[]
We recommend exploring the documentation further {cljdoc-doc-url}[here], where you’ll find a convenient menu on the left for easier navigation.
endif::[]
...
The tool also supports https://clojurescript.org[ClojureScript].
