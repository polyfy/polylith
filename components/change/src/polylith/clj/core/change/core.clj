...
(defn changes [{:keys [projects settings paths user-input]}
  ...
  (let [projects-deps (mapv (juxt :name :deps) projects)
        ...
        project-to-bricks-to-test (bricks-to-test/project-to-bricks-to-test changed-projects projects changed-components changed-bases project-to-indirect-changes selected-bricks selected-projects is-dev is-run-all-brick-tests)
