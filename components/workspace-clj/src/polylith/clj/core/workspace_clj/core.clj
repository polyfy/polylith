...
(defn workspace-from-disk
  ...
  ([ws-dir
   ...
   (let [interface-namespace (or interface-ns "interface")
         ...
         dev-lib-deps (:lib-deps (common/find-project "development" projects))
         ns-to-lib-str (stringify (or ns-to-lib {}))
         components (components-from-disk/read-components ws-dir input-type user-home top-namespace ns-to-lib-str top-src-dir component-names interface-namespace brick->non-top-namespaces dev-lib-deps)
         bases (bases-from-disk/read-bases ws-dir input-type user-home top-namespace ns-to-lib-str top-src-dir brick->non-top-namespaces dev-lib-deps)
