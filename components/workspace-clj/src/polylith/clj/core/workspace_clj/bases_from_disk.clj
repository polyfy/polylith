...
(defn read-base [ws-dir input-type user-home top-namespace ns-to-lib top-src-dir brick->non-top-namespaces base-name]
...
(defn read-bases [ws-dir input-type user-home top-namespace ns-to-lib top-src-dir brick->non-top-namespaces]
  "Reads bases from disk"
  (let [base-names (file/directories (str ws-dir "/bases"))]
    (vec (sort-by :name (map #(read-base ws-dir input-type user-home top-namespace ns-to-lib top-src-dir brick->non-top-namespaces %) base-names)))))
