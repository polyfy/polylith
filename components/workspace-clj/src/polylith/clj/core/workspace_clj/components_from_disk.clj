...
(defn read-component [ws-dir ws-type user-home top-namespace ns-to-lib top-src-dir component-name interface-ns-name brick->non-top-namespaces]
  (let [component-dir (str ws-dir "/components/" component-name)
        ...
        definitions (defs-from-disk/defs-from-disk src-dir interface-ns-name)
...
(defn read-components [ws-dir ws-type user-home top-namespace ns-to-lib top-src-dir interface-ns-name brick->non-top-namespaces]
  (vec (sort-by :name (map #(read-component ws-dir ws-type user-home top-namespace ns-to-lib top-src-dir % interface-ns-name brick->non-top-namespaces)
