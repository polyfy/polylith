...
(defn create-component [ws-dir settings component-name interface-name is-git-add]
  (let [{:keys [top-namespace interface-ns]} settings
        ...
        interface-ns-name (:name interface-ns)]
    ...
    (brick/create-src-ns ws-dir top-namespace components-dir interface-ns-name interface-name is-git-add)
    (brick/create-test-ns ws-dir top-namespace components-dir interface-ns-name interface-name interface-name is-git-add)))
