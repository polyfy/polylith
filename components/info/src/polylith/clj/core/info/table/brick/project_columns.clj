(ns ^:no-doc polylith.clj.core.info.table.brick.project-columns
...
(defn column [index {:keys [alias paths bricks-to-test is-dev]}
              bricks disk-paths
              is-show-loc is-show-resources thousand-separator]
  (let [column (if is-dev 501 (+ 7 (* 2 index)))
