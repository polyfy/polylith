...
(deftest errors--when-no-active-profiles--ignore-error
  (is (= (m107/errors "info" settings projects color/none)
         nil)))

(deftest errors--when-projects-with-missing-components--return-error
  (is (= (m107/errors "info" (assoc settings :active-profiles #{"default"}) projects color/none)
...
(deftest errors--when-projects-with-missing-components-in-test-context--return-error
  (is (= (m107/errors "check" settings2 projects2 color/none)
         [{:type              "error"
           :code              107
