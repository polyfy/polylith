...
(defn validate-ws [ws-dir suffixed-top-ns settings interface-names interfaces components bases environments interface-ns ns->lib {:keys [active-dev-profiles]} color-mode]
