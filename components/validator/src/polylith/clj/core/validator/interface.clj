...
(defn validate-ws [settings configs disable libraries paths interface-names interfaces profiles components bases projects config-errors interface-ns user-input color-mode]
  (core/validate-ws settings configs disable libraries paths interface-names interfaces profiles components bases projects config-errors interface-ns user-input color-mode))
