...
(defn validate-ws [settings configs disable libraries paths interface-names interfaces profiles components bases projects config-errors interface-ns {:keys [cmd is-dev]} color-mode]
  (->> [(m101/errors components bases disable interface-ns color-mode)
        (m102/errors components disable color-mode)
        (m103/errors interfaces components disable color-mode)
        (m104/errors projects disable color-mode)
        (m105/errors interface-names components bases color-mode)
        (m106/errors components projects disable color-mode)
        (m107/errors cmd settings profiles bases projects disable color-mode)
        (m108/errors interfaces projects paths color-mode)
        (m109/errors settings disable color-mode)
        (m110/errors config-errors)
        (m111/errors components bases projects disable color-mode)
        (m112/errors configs disable color-mode)
