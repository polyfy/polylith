...
(defn enrich [ws-dir suffixed-top-ns bases interface-names outdated-libs library->latest-version {:keys [namespaces lib-deps] :as base}]
  (let [interface-deps (deps/interface-deps suffixed-top-ns interface-names base)
        ...
        lib-deps (lib/lib-deps-with-latest-version lib-deps outdated-libs library->latest-version)]
