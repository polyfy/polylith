...
(deftest ws-table--without-loc-info--return-table-without-loc-info
  (is (= ["  interface      brick          cli   core  dev "
          "  ----------------------------------------------"
          "  change         change         x-x-  x---  x-x-"
          "  command        command        x-xx  ----  x-x-"
          "  common         common         x-x-  x---  x-x-"
          "  create         create         xxx-  ----  xxx-"
          "  deps           deps           x-x-  x---  x-x-"
          "  entity         entity *       x-xx  x---  x-x-"
          "  file           file           x-x-  x---  x-x-"
          "  git            git            x-x-  x---  x-x-"
          "  help           help           x---  x---  x---"
          "  shell          shell          x---  x---  x---"
          ...
          "  util           util           x-x-  x---  x-x-"
          "  validate       validate       x-x-  x---  x-x-"
          "  workspace      workspace *    x-xx  x---  x-x-"
          "  workspace-clj  workspace-clj  x-x-  ----  x-x-"
          "  -              cli            x---  ----  x---"]
