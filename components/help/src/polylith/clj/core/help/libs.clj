...
(defn help [cm]
  (str "  Shows all libraries that are used in the workspace.\n"
       ...
       "  reason they have only one " (color/project "-" cm) "/" (color/project "x" cm) ".\n"
       "\n"
       ...
       "  The " (color/project "-" cm) " in " (color/project "x-" cm) " says that the library isn't included for the test scope. A library used in the\n"
