...
(defn help-text [cm]
  (str "  Shows workspace information.\n"
       ...
       "    " (color/project "development   dev     x--     x--   --" cm) "\n"
       "\n"
       ...
       "      " (color/project "x--" cm) "  The project has a 'src' directory, e.g.\n"
       "           'projects/command-line/src'.\n"
       "      " (color/project "-x-" cm) "  The project has a 'test' directory, e.g.\n"
       ...
       "      " (color/project "x---" cm) "  The project has a 'src' directory, e.g.\n"
       "            'projects/command-line/src'.\n"
       "      " (color/project "-x--" cm) "  The project has a 'resources' directory, e.g.\n"
       ...
       "\n"
       ""
       "    The " (s/key "dev" cm) " column has three x/- flags with different meaning:\n"
       "      " (color/project "x--" cm) "  The project's 'src' directory, e.g.\n"
       "           'projects/command-line/src' is added to './deps.edn'\n"
       "           (or indirectly added as :local/root).\n"
       "      " (color/project "-x-" cm) "  The project's 'test' directory, e.g.\n"
       ...
       "      " (color/project "x-" cm) "  The profile contains a path to the 'src' directory, e.g.\n"
       "          'projects/command-line/src'.\n"
       "      " (color/project "-x" cm) "  The profile contains a path to the 'test' directory, e.g.\n"
       "          'projects/command-line/test'.\n"
       "\n"
       "    If also passing in :r or :resources, e.g. 'poly info +r':\n"
       "      " (color/project "x--" cm) "  The profile contains a path to the 'src' directory, e.g.\n"
       "           'projects/command-line/src'.\n"
       "      " (color/project "-x-" cm) "  The profile contains a path to the 'resources' directory, e.g.\n"
       "           'projects/command-line/resources'.\n"
       "      " (color/project "--x" cm) "  The profile contains a path to the 'test' directory, e.g.\n"
       "           'projects/command-line/test'.\n"
       "\n"
       ...
       "\n"
       "    The flags mean:\n"
       "      " (color/project "x--" cm) "  The project contains a path to the 'src' directory, e.g.\n"
       "           'components/user/src' (or is indirectly added by a :local/root).\n"
       "      " (color/project "-x-" cm) "  The project contains a path to the 'test' directory, e.g.\n"
       ...
       "      " (color/project "x---" cm) "  The project contains a path to the 'src' directory, e.g. \n"
       "            'components/user/src' (or is indirectly added by a :local/root).\n"
       "      " (color/project "-x--" cm) "  The project contains a path to the 'resources' directory, e.g.\n"
