...
(defn help-text [cm]
  (str "  Shows workspace information.\n"
       ...
       "     " (color/project "development" cm) " project. A profiles is an aliase in ./deps.edn that starts\n"
       ...
       "\n"
       "    Aliases are configured in " (color/purple cm ":project-to-alias") " in ./deps.edn.\n"
       "\n"
