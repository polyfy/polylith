...
(defn help-text [color-mode]
  (str "  Shows a table with the following columns (where 'brick' is either a " (color/component "component" color-mode) " or a " (color/base "base" color-mode) "):\n"
       ...
       "                  Each environment column has two characters.\n"
       "                    The first character:\n"
       "                      'x' = the brick's 'src' folder is part of the environment\n"
       "                      '-' = the brick's 'src' folder is not part of the environment\n"
       "                    The second character:\n"
       "                      'x' = the brick's 'test' folder is part of the environment\n"
       "                      '+' = the brick's 'test' folder is part of the environment and it depends on at least\n"
       "                            one other component (directly or indirectly) that has changed.\n"
       "                      '-' = the brick's 'test' folder is not part of the environment\n"
