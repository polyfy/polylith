...
(defn brick-deps [ws-alias suffixed-top-ns interface-names workspaces brick]
  (brick-deps/brick-deps ws-alias suffixed-top-ns interface-names workspaces brick))
