...
(defn with-test-calculations [{:keys [ws-dir user-input projects paths changed-components changed-bases changed-projects changed-or-affected-projects] :as workspace}]
